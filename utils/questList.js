  ...
  return [
    {
      ...
      long_description:
        "Let's Mint your mainnet challenge NFT ! You will keep it throughout your journey. As you complete quests (like this one), your NFT will gain levels and evolve! Good luck ;-)",
      icon: (
        <svg
          ...
          connected: [
            {
              ...
              id: 8,
              description:
                "Verify your Twitter account on Starknet.id, and unlock exclusive quests.",
              icon: (
                <svg
                  className={styles.quest_point_icon}
                  fill="none"
              ...
              steps: [6, 4],
              customContent: [<p>Verify your twitter</p>],
              details: {
                0: {
                  buttons: [
                    <a
                      href={
                        "https://goerli.app.starknet.id/identities/" +
                        datas.identityTokenId +
                        "/"
                      }
                      target="_blank"
                      rel="noreferrer"
                    >
                      <button className="button gold">Open Starknet.id</button>
                    </a>,
                  ],
                },
              },
              connected: [
                {
                  ...
                  customContent: [
                    <p>
                      <a
                        className="link"
                        href="https://twitter.com/intent/user?screen_name=Starknet_id"
                        target="_blank"
                        rel="noreferrer"
                      >
                        Follow us
                  ...
                  connected: [
                    {
                      ...
                      description: (
                        <>
                          Buy a .stark domain on{" "}
                          <a
                            className="link"
                            href="https://goerli.app.starknet.id/"
                            target="_blank"
                            rel="noreferrer"
                          >
                            Starknet.id
                      ...
                      connected: [
                        {
                          ...
                          id: 9,
                          description:
                            "Make a tweet mentioning Starknet.id to support us ❤️",
                          icon: (
                            <svg
                              className={styles.quest_point_icon}
                              fill="none"
                          ...
                          customContent: [
                            <p>
                              ...
                              <a
                                className="link"
                                href="https://twitter.com/intent/tweet?text=I%20claimed%20my%20%22.stark%22%20domain%20name%20on%20%40Starknet_id%0A%0AClaim%20yours%20before%20it's%20too%20late%20for%20a%20big%20surprise%20%F0%9F%91%80%20...%20%0A%0A%23StarkNet%20%23StarknetIdOdyssey%20"
                                target="_blank"
                                rel="noreferrer"
                              >
                                this tweet
                              </a>{" "}
                              including a screenshot of your own identity, then
                              click Okay
                            </p>,
                          ],
                        },
                        {
                          ...
                          customContent: [
                            <p>
                              Set your .stark domain as main domain on{" "}
                              <a
                                className="link"
                                href="https://goerli.app.starknet.id/"
                                target="_blank"
                    ...
                    },
                    {
                      ...
                      id: 6,
                      description:
                        "Change your twitter profile pic by your identity avatar",
                      icon: (
                        <svg
                          className={styles.quest_point_icon}
                          fill="none"
                      ...
                      customContent: [
                        <p>
                          Change your twitter profile pic by your identity
                          avatar. Don't try to cheat, or you won't get the final
                          reward 🤨
                        </p>,
                      ],
                      details: {
