                            ...
                            connected: [
                                {
                                    ...
                                    customContent: [
                                        <p>
                                            <a className='link' href="https://twitter.com/intent/user?screen_name=Starknet_id" target="_blank" rel="noreferrer">Follow us</a>, then click Okay
                                        </p>,
                                    ],
                                    connected: [
                                        {
                                            name: "Get a domain",
                                            id: 12,
                                            description: <>Buy a .stark domain on <a className='link' href='https://goerli.app.starknet.id/domains' target="_blank" rel="noreferrer">Starknet.id</a></>,
                                            icon: <svg className={styles.quest_point_icon} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                            ...
                                            customContent: [
                                                <p>
                                                    Buy a .stark domain on <a className='link' href="https://goerli.app.starknet.id/domains" target="_blank" rel="noreferrer">Starknet.id</a>, then click Okay
                                                </p>,
                                            ],
                                                connected: [
                                                    {
                                                        ...
                                                        customContent: [
                                                            <p>
                                                                Post <a className='link' href="https://twitter.com/intent/tweet?text=I%20claimed%20my%20%22.stark%22%20domain%20name%20on%20%40Starknet_id%0A%0AClaim%20yours%20before%20it's%20too%20late%20for%20a%20big%20surprise%20%F0%9F%91%80%20...%20%0A%0A%23StarkNet%20%23StarknetIdOdyssey%20" target="_blank" rel="noreferrer">this tweet</a> including a screenshot of your own identity, then click Okay
                                                            </p>,
                                                        ],
                                                    },
                                                    {
